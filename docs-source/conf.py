# -*- coding: utf-8 -*-
#
# upytester documentation build configuration file, created by
# sphinx-quickstart on Sat Apr 13 10:45:20 2019.
#
...
version = upytester.__version__
# The full version, including alpha/beta/rc tags.
release = upytester.__version__
...
htmlhelp_basename = 'upytesterdoc'
...
latex_documents = [
    (master_doc, 'upytester.tex', u'upytester Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'upytester', u'upytester Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'upytester', u'upytester Documentation',
     author, 'upytester', 'One line description of project.',
     'Miscellaneous'),
]
